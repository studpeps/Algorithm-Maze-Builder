...
def mainpage():
    ...
    platbtn = button((0, 0, 0), 175+175, 350, 200, 100, FILEPATH, (0, 0, 0), text='Maze')
    sortbtn = button((0, 0, 0), 385+175, 350, 200, 100, FILEPATH, (0, 0, 0), text='Sort')
    helpbtn = button((0, 0, 0), 595+175, 350, 200, 100, FILEPATH, (0, 0, 0), text='Help')
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1:
                    if platbtn.isOver(pos):
                        pygame.display.set_caption("Visualiser: Maze")
                        Quit = maze.main()
                        invp = False
                    if sortbtn.isOver(pos):
                        pygame.display.set_caption("Visualiser: Sort")
                        Quit = sort.sortloop()
                        invs = False
